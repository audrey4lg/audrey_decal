...
#4  Anaconda is more data science focused and includes Jupiter Notebook and uses the language of python. Python is simply a programming language and less of a software where other things can be done. Conda seems to be the manager/organizer of the anaconda program.
#5 Jupyter Notebook is another platform that uses different languages but is used more for data science. Jupyter Lab seems to offer a large selection of things including notebooks.
